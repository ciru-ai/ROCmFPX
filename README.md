...
This tree is based directly on official `ggml-org/llama.cpp` commit
`15586e2d7165570fb3aa7c26e0d442e289ef69de` (`b10297` plus one commit,
2026-08-06). It therefore includes the upstream decode overhaul through
`b10218`. See [UPSTREAM.md](UPSTREAM.md) for the synchronization policy and
